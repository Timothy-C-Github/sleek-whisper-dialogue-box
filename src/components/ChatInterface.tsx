          ...
          <div className="flex space-x-3">
            <div className="flex-1 relative">
              <Input
                ...
                disabled={isLoading}
                className="pr-12 py-3 text-sm border-gray-300 rounded-full focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
            <Button
              type="submit"
              ...
              size="sm"
              className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-full transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
